...
internal fun ExampleContentItemRoute(
    ...
    <style>
    body{
        background-color: ${hex(GovUkTheme.colourScheme.surfaces.background)};
        color: ${hex(GovUkTheme.colourScheme.textAndIcons.primary)};
        padding: 20px;
    }
    /* copied from component guide */
...
.govspeak.gem-c-govspeak--direction-rtl .attachment,.gem-c-govspeak.gem-c-govspeak--direction-rtl .attachment {
    padding: 15px 129px 0 0
}

.govspeak.gem-c-govspeak--direction-rtl .attachment .attachment-thumb,.gem-c-govspeak.gem-c-govspeak--direction-rtl .attachment .attachment-thumb {
    float: right;
    margin-left: 0;
    margin-right: -114px
}

.govspeak .govuk-button,.govspeak .gem-c-button,.gem-c-govspeak .govuk-button,.gem-c-govspeak .gem-c-button {
    font-family: "GDS Transport",arial,sans-serif;
    -webkit-font-smoothing: antialiased;
    -moz-osx-font-smoothing: grayscale;
    font-weight: 400;
    ...
    border-radius: 0;
    color: ${hex(GovUkTheme.colourScheme.textAndIcons.buttonPrimary)};
    background-color: ${hex(GovUkTheme.colourScheme.surfaces.buttonSecondary)};
    /* TODO - not sure what button drop shadow should look like... */
...
.govspeak .govuk-button:link,.govspeak .gem-c-button:link,.govspeak .govuk-button:visited,.govspeak .gem-c-button:visited,.govspeak .govuk-button:active,.govspeak .gem-c-button:active,.govspeak .govuk-button:hover,.govspeak .gem-c-button:hover,.gem-c-govspeak .govuk-button:link,.gem-c-govspeak .gem-c-button:link,.gem-c-govspeak .govuk-button:visited,.gem-c-govspeak .gem-c-button:visited,.gem-c-govspeak .govuk-button:active,.gem-c-govspeak .gem-c-button:active,.gem-c-govspeak .govuk-button:hover,.gem-c-govspeak .gem-c-button:hover {
    color: #fff;
    text-decoration: none
}

.govspeak .govuk-button::-moz-focus-inner,.govspeak .gem-c-button::-moz-focus-inner,.gem-c-govspeak .govuk-button::-moz-focus-inner,.gem-c-govspeak .gem-c-button::-moz-focus-inner {
    padding: 0;
    border: 0
}

.govspeak .govuk-button:hover,.govspeak .gem-c-button:hover,.gem-c-govspeak .govuk-button:hover,.gem-c-govspeak .gem-c-button:hover {
    background-color: rgb(0,89.6,48)
}

.govspeak .govuk-button:active,.govspeak .gem-c-button:active,.gem-c-govspeak .govuk-button:active,.gem-c-govspeak .gem-c-button:active {
    top: 2px
}

.govspeak .govuk-button:focus,.govspeak .gem-c-button:focus,.gem-c-govspeak .govuk-button:focus,.gem-c-govspeak .gem-c-button:focus {
    border-color: #fd0;
    outline: 3px solid rgba(0,0,0,0);
    box-shadow: inset 0 0 0 1px #fd0
}

.govspeak .govuk-button:focus:not(:active):not(:hover),.govspeak .gem-c-button:focus:not(:active):not(:hover),.gem-c-govspeak .govuk-button:focus:not(:active):not(:hover),.gem-c-govspeak .gem-c-button:focus:not(:active):not(:hover) {
    border-color: #fd0;
    color: #0b0c0c;
...
.govspeak .govuk-button::before,.govspeak .gem-c-button::before,.gem-c-govspeak .govuk-button::before,.gem-c-govspeak .gem-c-button::before {
    content: "";
    display: block;
    position: absolute;
    top: -2px;
...
.govspeak .govuk-button:active::before,.govspeak .gem-c-button:active::before,.gem-c-govspeak .govuk-button:active::before,.gem-c-govspeak .gem-c-button:active::before {
    top: -4px
}

.govspeak .govuk-button[disabled],.govspeak [disabled].gem-c-button,.gem-c-govspeak .govuk-button[disabled],.gem-c-govspeak [disabled].gem-c-button {
    opacity: .5
}

.govspeak .govuk-button[disabled]:hover,.govspeak [disabled].gem-c-button:hover,.gem-c-govspeak .govuk-button[disabled]:hover,.gem-c-govspeak [disabled].gem-c-button:hover {
    background-color: #00703c;
    cursor: not-allowed
}

.govspeak .govuk-button[disabled]:active,.govspeak [disabled].gem-c-button:active,.gem-c-govspeak .govuk-button[disabled]:active,.gem-c-govspeak [disabled].gem-c-button:active {
    top: 0;
    box-shadow: 0 2px 0 rgb(0,44.8,24)
}

.govspeak .govuk-button--secondary,.gem-c-govspeak .govuk-button--secondary {
    background-color: #f3f2f1;
    box-shadow: 0 2px 0 rgb(145.8,145.2,144.6)
}

.govspeak .govuk-button--secondary,.govspeak .govuk-button--secondary:link,.govspeak .govuk-button--secondary:visited,.govspeak .govuk-button--secondary:active,.govspeak .govuk-button--secondary:hover,.gem-c-govspeak .govuk-button--secondary,.gem-c-govspeak .govuk-button--secondary:link,.gem-c-govspeak .govuk-button--secondary:visited,.gem-c-govspeak .govuk-button--secondary:active,.gem-c-govspeak .govuk-button--secondary:hover {
    color: #0b0c0c
}

.govspeak .govuk-button--secondary:hover,.gem-c-govspeak .govuk-button--secondary:hover {
    background-color: rgb(218.7,217.8,216.9)
}

.govspeak .govuk-button--secondary:hover[disabled],.gem-c-govspeak .govuk-button--secondary:hover[disabled] {
    background-color: #f3f2f1
}

.govspeak .govuk-button--warning,.gem-c-govspeak .govuk-button--warning {
    background-color: #d4351c;
    box-shadow: 0 2px 0 rgb(84.8,21.2,11.2)
}

.govspeak .govuk-button--warning,.govspeak .govuk-button--warning:link,.govspeak .govuk-button--warning:visited,.govspeak .govuk-button--warning:active,.govspeak .govuk-button--warning:hover,.gem-c-govspeak .govuk-button--warning,.gem-c-govspeak .govuk-button--warning:link,.gem-c-govspeak .govuk-button--warning:visited,.gem-c-govspeak .govuk-button--warning:active,.gem-c-govspeak .govuk-button--warning:hover {
    color: #fff
}

.govspeak .govuk-button--warning:hover,.gem-c-govspeak .govuk-button--warning:hover {
    background-color: rgb(169.6,42.4,22.4)
}

.govspeak .govuk-button--warning:hover[disabled],.gem-c-govspeak .govuk-button--warning:hover[disabled] {
    background-color: #d4351c
}

.govspeak .govuk-button--inverse,.gem-c-govspeak .govuk-button--inverse {
    background-color: #fff;
    box-shadow: 0 2px 0 rgb(20.3,78.4,128.8)
}

.govspeak .govuk-button--inverse,.govspeak .govuk-button--inverse:link,.govspeak .govuk-button--inverse:visited,.govspeak .govuk-button--inverse:active,.govspeak .govuk-button--inverse:hover,.gem-c-govspeak .govuk-button--inverse,.gem-c-govspeak .govuk-button--inverse:link,.gem-c-govspeak .govuk-button--inverse:visited,.gem-c-govspeak .govuk-button--inverse:active,.gem-c-govspeak .govuk-button--inverse:hover {
    color: #1d70b8
}

.govspeak .govuk-button--inverse:hover,.gem-c-govspeak .govuk-button--inverse:hover {
    background-color: rgb(232.4,240.7,247.9)
}

.govspeak .govuk-button--inverse:hover[disabled],.gem-c-govspeak .govuk-button--inverse:hover[disabled] {
    background-color: #fff
}

.govspeak .govuk-button--start,.gem-c-govspeak .govuk-button--start {
    font-weight: 700;
    font-size: 1.3125rem;
    line-height: 1;
    display: inline-flex;
...
.govspeak .govuk-button__start-icon,.gem-c-govspeak .govuk-button__start-icon {
    margin-left: 5px;
...
.govspeak .mc-toggle-button:hover,.gem-c-govspeak .mc-toggle-button:hover {
    background-color: #f3f2f1;
    color: #003078
}
...
.govspeak .footnotes ol li:nth-of-type(99)~li,.gem-c-govspeak .footnotes ol li:nth-of-type(99)~li {
    margin-left: 11px
}

.govspeak .footnotes ol li:nth-of-type(999)~li,.gem-c-govspeak .footnotes ol li:nth-of-type(999)~li {
    margin-left: 22px
}
...
.govspeak .steps>li::before,.gem-c-govspeak .steps>li::before {
    background-color: #0b0c0c;
    border-radius: 50%;
    color: #fff;
    float: left;
...
.govspeak .steps>li:nth-child(1):before,.gem-c-govspeak .steps>li:nth-child(1):before {
    content: "1"
}

.govspeak .steps>li:nth-child(2):before,.gem-c-govspeak .steps>li:nth-child(2):before {
    content: "2"
}

.govspeak .steps>li:nth-child(3):before,.gem-c-govspeak .steps>li:nth-child(3):before {
    content: "3"
}

.govspeak .steps>li:nth-child(4):before,.gem-c-govspeak .steps>li:nth-child(4):before {
    content: "4"
}

.govspeak .steps>li:nth-child(5):before,.gem-c-govspeak .steps>li:nth-child(5):before {
    content: "5"
}

.govspeak .steps>li:nth-child(6):before,.gem-c-govspeak .steps>li:nth-child(6):before {
    content: "6"
}

.govspeak .steps>li:nth-child(7):before,.gem-c-govspeak .steps>li:nth-child(7):before {
    content: "7"
}

.govspeak .steps>li:nth-child(8):before,.gem-c-govspeak .steps>li:nth-child(8):before {
    content: "8"
}

.govspeak .steps>li:nth-child(9):before,.gem-c-govspeak .steps>li:nth-child(9):before {
    content: "9"
}

.govspeak .steps>li:nth-child(10):before,.gem-c-govspeak .steps>li:nth-child(10):before {
    content: "10"
}

.govspeak .steps>li:nth-child(11):before,.gem-c-govspeak .steps>li:nth-child(11):before {
    content: "11"
}

.govspeak .steps>li:nth-child(12):before,.gem-c-govspeak .steps>li:nth-child(12):before {
    content: "12"
}

.govspeak .steps>li:nth-child(13):before,.gem-c-govspeak .steps>li:nth-child(13):before {
    content: "13"
}

.govspeak .steps>li:nth-child(14):before,.gem-c-govspeak .steps>li:nth-child(14):before {
    content: "14"
}

.govspeak .steps>li:nth-child(15):before,.gem-c-govspeak .steps>li:nth-child(15):before {
    content: "15"
}

.govspeak .steps>li:nth-child(16):before,.gem-c-govspeak .steps>li:nth-child(16):before {
    content: "16"
}

.govspeak .steps>li:nth-child(17):before,.gem-c-govspeak .steps>li:nth-child(17):before {
    content: "17"
}

.govspeak .steps>li:nth-child(18):before,.gem-c-govspeak .steps>li:nth-child(18):before {
    content: "18"
}

.govspeak .steps>li:nth-child(19):before,.gem-c-govspeak .steps>li:nth-child(19):before {
    content: "19"
}

.govspeak .steps>li:nth-child(20):before,.gem-c-govspeak .steps>li:nth-child(20):before {
    content: "20"
}

.govspeak .steps>li:nth-child(21):before,.gem-c-govspeak .steps>li:nth-child(21):before {
    content: "21"
}

.govspeak .steps>li:nth-child(22):before,.gem-c-govspeak .steps>li:nth-child(22):before {
    content: "22"
}

.govspeak .steps>li:nth-child(23):before,.gem-c-govspeak .steps>li:nth-child(23):before {
    content: "23"
}

.govspeak .steps>li:nth-child(24):before,.gem-c-govspeak .steps>li:nth-child(24):before {
    content: "24"
}

.govspeak .steps>li:nth-child(25):before,.gem-c-govspeak .steps>li:nth-child(25):before {
    content: "25"
}

.govspeak .steps>li:nth-child(26):before,.gem-c-govspeak .steps>li:nth-child(26):before {
    content: "26"
}

.govspeak .steps>li:nth-child(27):before,.gem-c-govspeak .steps>li:nth-child(27):before {
    content: "27"
}

.govspeak .steps>li:nth-child(28):before,.gem-c-govspeak .steps>li:nth-child(28):before {
    content: "28"
}

.govspeak .steps>li:nth-child(29):before,.gem-c-govspeak .steps>li:nth-child(29):before {
    content: "29"
}

.govspeak .steps>li:nth-child(30):before,.gem-c-govspeak .steps>li:nth-child(30):before {
    content: "30"
}
...
.govspeak table th:last-child,.govspeak table td:last-child,.gem-c-govspeak table th:last-child,.gem-c-govspeak table td:last-child {
...
.govspeak table .cell-text-left,.gem-c-govspeak table .cell-text-left {
    text-align: left
}

.govspeak table .cell-text-center,.gem-c-govspeak table .cell-text-center {
    text-align: center
}

.govspeak table .cell-text-right,.gem-c-govspeak table .cell-text-right {
    text-align: right
}

.govuk-govspeak.gem-c-govspeak--direction-rtl table caption,.gem-c-govspeak.gem-c-govspeak--direction-rtl table caption {
    text-align: right
}

.govuk-govspeak.gem-c-govspeak--direction-rtl table th,.gem-c-govspeak.gem-c-govspeak--direction-rtl table th {
    text-align: right
}

.govuk-govspeak.gem-c-govspeak--direction-rtl table th,.govuk-govspeak.gem-c-govspeak--direction-rtl table td,.gem-c-govspeak.gem-c-govspeak--direction-rtl table th,.gem-c-govspeak.gem-c-govspeak--direction-rtl table td {
    padding: 10px 0 10px 20px
}

.gem-c-govspeak--direction-rtl .govspeak table caption,.gem-c-govspeak--direction-rtl .gem-c-govspeak table caption {
    text-align: right
}

.gem-c-govspeak--direction-rtl .govspeak table th,.gem-c-govspeak--direction-rtl .gem-c-govspeak table th {
    text-align: right
}

.gem-c-govspeak--direction-rtl .govspeak table th,.gem-c-govspeak--direction-rtl .govspeak table td,.gem-c-govspeak--direction-rtl .gem-c-govspeak table th,.gem-c-govspeak--direction-rtl .gem-c-govspeak table td {
    padding: 10px 0 10px 20px
}
...
.govspeak *+h2,.govspeak *+h3,.gem-c-govspeak *+h2,.gem-c-govspeak *+h3 {
    padding-top: 20px
}
...
.govspeak a:focus,.gem-c-govspeak a:focus {
    outline: 3px solid rgba(0,0,0,0);
    color: ${hex(GovUkTheme.colourScheme.textAndIcons.primary)};
    background-color: ${hex(GovUkTheme.colourScheme.textAndIcons.buttonPrimaryFocused)};
    box-shadow: 0 -2px ${hex(GovUkTheme.colourScheme.textAndIcons.buttonPrimaryFocused)},0 4px ${hex(GovUkTheme.colourScheme.textAndIcons.primary)};
    text-decoration: none;
    -webkit-box-decoration-break: clone;
    box-decoration-break: clone
}
...
.govspeak a:link,.gem-c-govspeak a:link {
    color: ${hex(GovUkTheme.colourScheme.textAndIcons.link)};
}
...
.govspeak code,.gem-c-govspeak code {
    padding: 0 5px;
    color: #d13118;
    background-color: #f3f2f1
}

.govspeak.gem-c-govspeak--direction-rtl ol,.govspeak.gem-c-govspeak--direction-rtl ul,.gem-c-govspeak.gem-c-govspeak--direction-rtl ol,.gem-c-govspeak.gem-c-govspeak--direction-rtl ul {
    margin-left: 0;
    margin-right: 20px
}

.govspeak.gem-c-govspeak--direction-rtl ol a,.govspeak.gem-c-govspeak--direction-rtl ul a,.gem-c-govspeak.gem-c-govspeak--direction-rtl ol a,.gem-c-govspeak.gem-c-govspeak--direction-rtl ul a {
    overflow-wrap: break-word
}

.govspeak.gem-c-govspeak--direction-rtl ol ul,.govspeak.gem-c-govspeak--direction-rtl ol ol,.govspeak.gem-c-govspeak--direction-rtl ul ul,.govspeak.gem-c-govspeak--direction-rtl ul ol,.gem-c-govspeak.gem-c-govspeak--direction-rtl ol ul,.gem-c-govspeak.gem-c-govspeak--direction-rtl ol ol,.gem-c-govspeak.gem-c-govspeak--direction-rtl ul ul,.gem-c-govspeak.gem-c-govspeak--direction-rtl ul ol {
    margin-bottom: 0
}
...
.govspeak blockquote p:last-of-type::after,.gem-c-govspeak blockquote p:last-of-type::after {
    content: "”"
}

.govspeak.gem-c-govspeak--direction-rtl blockquote,.gem-c-govspeak.gem-c-govspeak--direction-rtl blockquote {
    padding: 0 20px 0 0
}
...
.govspeak.gem-c-govspeak--direction-rtl blockquote p,.gem-c-govspeak.gem-c-govspeak--direction-rtl blockquote p {
    padding-right: 15px;
    padding-left: 0
}
...
.govspeak.gem-c-govspeak--direction-rtl blockquote p::before,.gem-c-govspeak.gem-c-govspeak--direction-rtl blockquote p::before {
    content: "”";
    float: right;
    margin-right: -15px;
    margin-left: 0
...
.govspeak.gem-c-govspeak--direction-rtl blockquote p:last-child::after,.gem-c-govspeak.gem-c-govspeak--direction-rtl blockquote p:last-child::after {
    content: "“"
}
...
.govspeak .govuk-warning-text,.gem-c-govspeak .govuk-warning-text {
    font-family: "GDS Transport",arial,sans-serif;
    -webkit-font-smoothing: antialiased;
    -moz-osx-font-smoothing: grayscale;
    font-weight: 400;
...
.govspeak .govuk-warning-text__icon,.govspeak .help-notice::before,.gem-c-govspeak .govuk-warning-text__icon,.gem-c-govspeak .help-notice::before {
    box-sizing: border-box;
    display: inline-block;
    position: absolute;
    left: 0;
...
.govspeak .govuk-warning-text__text,.gem-c-govspeak .govuk-warning-text__text {
    color: #0b0c0c;
    display: block;
    padding-left: 45px;
    font-weight: inherit
...
.govspeak .help-notice::before,.gem-c-govspeak .help-notice::before {
    content: "!";
    font-weight: 700
}
...
.govspeak.gem-c-govspeak--direction-rtl,.gem-c-govspeak.gem-c-govspeak--direction-rtl {
    direction: rtl;
    text-align: start
}
        ...
        withContext(Dispatchers.IO) {
            ...
            webView!!.post {
                webView!!.loadDataWithBaseURL(
                    null,
                    "$customCss<div class=\"gem-c-govspeak govuk-govspeak\">$introParagraph<div>",
