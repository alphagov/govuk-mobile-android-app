...
internal data class EditTopicsUiState(
...
internal class EditTopicsViewModel @Inject constructor(
    ...
    private val _uiState: MutableStateFlow<EditTopicsUiState?> = MutableStateFlow(null)
    ...
    init {
        viewModelScope.launch {
            ...
            topicsRepo.topics.collect { topics ->
                _uiState.value = EditTopicsUiState(topics.map { topicItem -> topicItem.toTopicUi() })
            }
        }
    }
