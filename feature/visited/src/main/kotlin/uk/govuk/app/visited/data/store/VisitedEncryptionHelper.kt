...
internal class VisitedEncryptionHelper @Inject constructor(
    private val dataStore: VisitedDataStore
) {
    private companion object {
        private const val KEYSTORE_KEY_ALIAS = "realm_visited_key"
    }
    ...
    suspend fun getRealmKey(): ByteArray {
        val encryptedRealmKey = dataStore.getRealmVisitedKey()
        val realmIv = dataStore.getRealmVisitedIv()
    ...
    private suspend fun encryptAndSaveRealmKey(realmKey: ByteArray, keystoreKey: SecretKey) {
        ...
        dataStore.saveRealmVisitedKey(encodedKey)
        dataStore.saveRealmVisitedIv(encodedIv)
    }
}
